                    ...
                    <div className={`p-3 rounded-2xl border flex items-center justify-between gap-3 ${subContainerClass}`}>
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] font-mono font-bold tracking-wide">SPEECH MATCH SCORE</span>
                                <span className="text-[9px] text-slate-400">{isRecording ? 'Listening...' : 'Tap mic and read aloud the English word'}</span>
                            </div>
                        </div>
                        {pronunciationScore !== null && (
                            <div className="text-right">
                                <span className={`text-xs font-mono font-black ${pronunciationScore >= 80 ? 'text-green-400' : 'text-orange-400'}`}>{pronunciationScore}%</span>
                            </div>
                        )}
                    </div>
